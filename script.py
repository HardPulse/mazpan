...
cmd1 = f'cmd /k D:\\Avtoreger\\data\\zenka\\KZ2\\aaa\\serv\\loophole.exe http 8006 --hostname {hostname1}'
...
cmd2 = f'cmd /k D:\\Avtoreger\\data\\zenka\\KZ2\\aaa\\serv\\loophole.exe http 3006 --hostname {hostname2}'
...
# 4. Запуск backend
cmd3 = r'cd /d D:\Avtoreger\data\zenka\KZ2\aaa\app\backend && start "Backend" cmd /k uvicorn server:app --host 0.0.0.0 --port 8006 --reload'
...
# 5. Запуск frontend
cmd4 = r'cd /d D:\Avtoreger\data\zenka\KZ2\aaa\app\frontend && set PORT=3006 && start "Frontend" cmd /k npm start'
